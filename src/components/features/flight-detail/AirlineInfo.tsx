      ...
      <CardContent className="space-y-6 px-6 py-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400">{fleetType}</p>
          </div>
        </div>
        ...
        <div className="space-y-3 rounded-[1.5rem] border border-slate-200/80 bg-slate-50/80 p-4 dark:border-slate-800/80 dark:bg-slate-900/50">
          ...
          <Progress value={onTimePerformance} className="h-2.5 bg-slate-200 dark:bg-slate-800" />
        </div>
        ...
        <div className="grid gap-3 md:grid-cols-3">
          <div className="rounded-[1.4rem] border border-slate-200/80 px-4 py-4 dark:border-slate-800/80">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-slate-950 dark:text-stone-100">Carry-on</p>
          ...
          <div className="rounded-[1.4rem] border border-slate-200/80 px-4 py-4 dark:border-slate-800/80">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-slate-950 dark:text-stone-100">Checked bag</p>
                <p className="text-sm text-slate-500 dark:text-slate-400">
          ...
          <div className="rounded-[1.4rem] border border-slate-200/80 px-4 py-4 dark:border-slate-800/80">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-slate-950 dark:text-stone-100">Meal</p>
                <p className="text-sm text-slate-500 dark:text-slate-400">
