  ...
  return (
    <>
      ...
      <div className="lg:hidden">
        {mobileExpanded ? (
          <div className="fixed inset-x-4 bottom-4 z-40 rounded-[1.8rem] border border-slate-200/80 bg-white/95 shadow-[0_24px_80px_rgba(15,23,42,0.18)] backdrop-blur dark:border-slate-800/80 dark:bg-slate-950/95">
