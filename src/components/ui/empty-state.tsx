      ...
      <div className="mb-5 flex size-24 items-center justify-center rounded-full bg-[radial-gradient(circle,_rgba(20,184,166,0.18),_transparent_68%)] text-teal-700 dark:text-teal-300">
        {icon ?? (
          <svg viewBox="0 0 120 120" className="size-16" fill="none" aria-hidden="true">
            ...
            <path d="m34 75 16-31 18 17 18-24 16 38" stroke="currentColor" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" />
            <circle cx="42" cy="36" r="7" fill="currentColor" opacity=".35" />
          </svg>
        )}
      </div>
      <h3 className="text-xl font-semibold text-slate-900 dark:text-stone-100">{title}</h3>
